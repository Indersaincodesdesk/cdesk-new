...
@Component({
  selector: 'app-menshealthclinic',
  templateUrl: './menshealthclinic.component.html',
  styleUrls: ['./menshealthclinic.component.css']
})
export class MenshealthclinicComponent {
  name = "Angular";
