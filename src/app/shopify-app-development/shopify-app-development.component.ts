...
@Component({
  selector: 'app-shopify-app-development',
  templateUrl: './shopify-app-development.component.html',
  styleUrls: ['./shopify-app-development.component.css']
})
export class ShopifyAppDevelopmentComponent {
  name = "Angular";
