...
@Component({
  selector: 'app-anansipalaceforkids',
  templateUrl: './anansipalaceforkids.component.html',
  styleUrls: ['./anansipalaceforkids.component.css']
})
export class AnansipalaceforkidsComponent {
