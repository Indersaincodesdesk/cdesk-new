...
const routes: Routes = [
  ...
  { path: 'service/service-details', component: ServiceDetailsComponent },
  ...
  { path: 'service/shopify-web', component: ShopifyWebDevelopmentComponent },
  { path: 'service/strategy&cro', component: StrategyComponent },
  { path: 'service/data-migration', component: DataMigrationComponent },
  { path: 'service/shopify-app', component: ShopifyAppDevelopmentComponent },
  { path: 'resource/use-instagram-to-drive-sales', component: ShopifyAppsBlogComponent },
  { path: 'resource/apps-for-streamlining-your-business', component: Resource3Component },
