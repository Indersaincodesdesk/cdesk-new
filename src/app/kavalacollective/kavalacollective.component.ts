...
@Component({
  selector: 'app-kavalacollective',
  templateUrl: './kavalacollective.component.html',
  styleUrls: ['./kavalacollective.component.css']
})
export class KavalacollectiveComponent {
  name = "Angular";
