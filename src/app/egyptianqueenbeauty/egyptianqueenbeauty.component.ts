...
@Component({
  selector: 'app-egyptianqueenbeauty',
  templateUrl: './egyptianqueenbeauty.component.html',
  styleUrls: ['./egyptianqueenbeauty.component.css']
})
export class EgyptianqueenbeautyComponent {
  name = "Angular";
