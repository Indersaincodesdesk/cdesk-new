...
@Component({
  selector: 'app-shopify-web-development',
  templateUrl: './shopify-web-development.component.html',
  styleUrls: ['./shopify-web-development.component.css']
})
export class ShopifyWebDevelopmentComponent {
  name = "Angular";
